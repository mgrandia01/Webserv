...
#    Updated: 2026/07/29 07:59:41 by mgrandia         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = main.cpp \
      ...
      http/handler/HttpHandler.cpp \
      http/handler/HttpHandlerGet.cpp http/handler/HttpHandlerPost.cpp http/handler/HttpHandlerDelete.cpp \
      config/Config.cpp manager/ServerManager.cpp
